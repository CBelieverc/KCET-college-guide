...
public class mockquestions extends AppCompatActivity {
    ...
    private CardView imagecard,cardA, cardB, cardC, cardD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (url1111.contentEquals("phy_set1")) {
            questionList.add(new Question("question1234 ", Uri.parse("https://www.nitk.ac.in/"), "A", "B", "C", "D", "A"));
        ...
        ic_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                counter = 100;
                Intent intent = new Intent(mockquestions.this, MainActivity.class);
    ...
    private void setQuestion() {
        ...
        image.setImageURI(questionList.get(index).getImage());
